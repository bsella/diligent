...
pub struct EngineFactoryD3D12 {
    sys_ptr: *mut diligent_sys::IEngineFactoryD3D12,
    virtual_functions: *mut diligent_sys::IEngineFactoryD3D12Vtbl,
...
pub fn get_engine_factory_d3d12() -> EngineFactoryD3D12 {
    ...
    EngineFactoryD3D12 {
        sys_ptr: engine_factory_d3d12,
        virtual_functions: unsafe { (*engine_factory_d3d12).pVtbl },
...
impl EngineFactoryD3D12 {
    pub fn load_d3d12(&self) -> bool {
        unsafe {
            (*self.virtual_functions)
                .EngineFactoryD3D12
                .LoadD3D12
                .unwrap_unchecked()(self.sys_ptr, c"d3d12.dll".as_ptr())
        }
    }
    ...
    pub fn load_d3d12_from_path(&self, path: impl AsRef<Path>) -> bool {
        ...
        unsafe {
            (*self.virtual_functions)
                .EngineFactoryD3D12
                .LoadD3D12
                .unwrap_unchecked()(self.sys_ptr, path_str.as_ptr())
        }
    }
    ...
    > {
        ...
        let engine_ci = diligent_sys::EngineD3D12CreateInfo::from(engine_ci);
